...
*  1.2. Функції.
*  1.3. Вимоги.
2. Аналіз документів[link text](#Аналіз документів)
*  2.1. Класичні методи аналізу.
*  2.2. Формалізований метод аналізу.
*  2.3. Який метод обрати.
3. Види пошуку документів
*  3.1. Пошук за атрибутами документів.
*  3.2. Повнотекстовий пошук.
*  3.3. Фразовий пошук.
*  3.4. Пошук схожих документів.
*  3.5. Пошук нерозпізнаних документів.
*  3.6. Складні запити.
*  3.7. Пошук за регулярними виразами.
*  3.8. Цифрові відбитки.
4. Обробка природної мови
*  4.1. Задачі та обмеження.
*  4.2. Головні завдання.
*  4.3. Рівні обробки природної мови.
5. Розпізнавання іменованих сутностей
*  5.1. Визначення проблеми.
*  5.2. Формальна оцінка.
*  5.3. Підходи.
*  5.4. Проблеми з доменами.
*  5.5. Сучасні виклики та дослідження.
...
# Аналіз документів<a name="Аналіз документів"></a>
