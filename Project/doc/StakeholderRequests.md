...
|____________|______________|________________________|___________________|
...
Модуль синхронізації даних є зовнішньою обробкою OS KEYDATA і складається з функціонального елемента забезпечує синхронізацію даних і інтерфейсу користувача.
...
2. Імпорт даних про нові документація.
...
- Розсилати певні документи іншим фізичним особи
